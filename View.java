...
class View extends JFrame {
  ...
  public View() {
    ...
    triangleButton = new TriangleButton(undoManager, this, this.drawingPanel);
    moveButton = new MoveButton(undoManager, this, this.drawingPanel, model);
    rotateButton= new RotateButton(undoManager, this, this.drawingPanel, model);
